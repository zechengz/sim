        ...
        <div className="space-y-8 text-white/80">
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              employees, agents, and representatives (collectively, the "Company Parties") and
            ...
            <p className="mb-4">
              ...
              sending a timely written notice of your decision to opt out to: legal@simstudio.ai
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <li>
                ...
                is not authorized by the copyright owner; and
              </li>
              <li>
                A statement that the information in the notification is accurate, and under penalty
                of perjury, that you are the owner of the copyright or authorized to act on behalf
                of the owner.
              </li>
            </ul>
            <p>Copyright Agent Email: legal@simstudio.ai</p>
          </section>
