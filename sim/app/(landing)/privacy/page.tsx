          ...
          <div className="relative px-4 sm:px-8 py-4">
            ...
            <div className="space-y-8 text-white/80">
              ...
              <section>
                ...
                <p className="mb-4">
                  Under the following conditions, the meanings of words with capitalized first letters are defined. 
                ...
                <ul className="list-disc pl-6 space-y-2 mb-4 marker:text-[#B5A1D4]">
                  <li><span className="text-[#B5A1D4]">Account</span> means a unique account created for You to access our Service or parts of our Service.</li>
                  <li><span className="text-[#B5A1D4]">Affiliate</span> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
                  <li><span className="text-[#B5A1D4]">Application</span> means the software program provided by the Company downloaded by You on any electronic device.</li>
                  <li><span className="text-[#B5A1D4]">Business</span>, for the purpose of the CCPA (California Consumer Privacy Act), refers to the Company as the legal entity that collects Consumers' personal information and determines the purposes and means of the processing of Consumers' personal information, or on behalf of which such information is collected and that alone, or jointly with others, determines the purposes and means of the processing of consumers' personal information, that does business in the State of California.</li>
                  <li><span className="text-[#B5A1D4]">Company</span> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Sim Studio. For the purpose of the GDPR, the Company is the Data Controller.</li>
                  <li><span className="text-[#B5A1D4]">Cookies</span> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</li>
                  <li><span className="text-[#B5A1D4]">Country</span> refers to: Quebec, Canada</li>
                  <li><span className="text-[#B5A1D4]">Data Controller</span>, for the purposes of the GDPR (General Data Protection Regulation), refers to the Company as the legal person which alone or jointly with others determines the purposes and means of the processing of Personal Data.</li>
                  <li><span className="text-[#B5A1D4]">Device</span> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</li>
                  <li><span className="text-[#B5A1D4]">Do Not Track (DNT)</span> is a concept that has been promoted by US regulatory authorities, in particular the U.S. Federal Trade Commission (FTC), for the Internet industry to develop and implement a mechanism for allowing internet users to control the tracking of their online activities across websites.</li>
                  <li><span className="text-[#B5A1D4]">Personal Data</span> is any information that relates to an identified or identifiable individual. For the purposes for GDPR, Personal Data means any information relating to You such as a name, an identification number, location data, online identifier or to one or more factors specific to the physical, physiological, genetic, mental, economic, cultural or social identity. For the purposes of the CCPA, Personal Data means any information that identifies, relates to, describes or is capable of being associated with, or could reasonably be linked, directly or indirectly, with You.</li>
                  <li><span className="text-[#B5A1D4]">Sale</span>, for the purpose of the CCPA (California Consumer Privacy Act), means selling, renting, releasing, disclosing, disseminating, making available, transferring, or otherwise communicating orally, in writing, or by electronic or other means, a Consumer's Personal information to another business or a third party for monetary or other valuable consideration.</li>
                  <li><span className="text-[#B5A1D4]">Service</span> refers to the Application or the Website or both.</li>
                  <li><span className="text-[#B5A1D4]">Service Provider</span> means any natural or legal person who processes the data on behalf of the Company. It refers to third-party companies or individuals employed by the Company to facilitate the Service, to provide the Service on behalf of the Company, to perform services related to the Service or to assist the Company in analyzing how the Service is used. For the purpose of the GDPR, Service Providers are considered Data Processors.</li>
                  <li><span className="text-[#B5A1D4]">Third-party Social Media Service</span> refers to any website or any social network website through which a User can log in or create an account to use the Service.</li>
                  <li><span className="text-[#B5A1D4]">Usage Data</span> refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</li>
                  <li><span className="text-[#B5A1D4]">Website</span> refers to Sim Studio, accessible from simstudio.ai</li>
                  <li><span className="text-[#B5A1D4]">You</span> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable. Under GDPR (General Data Protection Regulation), You can be referred to as the Data Subject or as the User as you are the individual using the Service.</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="mb-4">
                  Google Ads remarketing service is provided by Google Inc. You can opt-out of Google Analytics for 
                  Display Advertising and customize the Google Display Network ads by visiting the Google Ads Settings page.
                </p>
              ...
              <section>
                ...
                <p className="mb-4">
                  ...
                  their Privacy Policy. These payment processors adhere to the standards set by PCI-DSS as managed 
                ...
                <h3 className="text-xl font-medium mb-2 text-[#B5A1D4]">Payment processors we work with:</h3>
                <ul className="list-disc pl-6 space-y-2 mb-4 marker:text-[#B5A1D4]">
                  <li>Stripe</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="mb-4">
                  Sim Studio's use and transfer to any other app of information received from Google APIs will adhere to 
              ...
              <section>
                ...
                <p className="mb-4">
                  Sim Studio is dedicated to preserving data security by preventing unauthorized disclosure of information. 
                  This policy was created to provide security researchers with instructions for conducting vulnerability 
                  discovery activities and to provide information on how to report vulnerabilities that have been discovered. 
                  This policy explains which systems and sorts of activity are covered, how to send vulnerability reports, 
                  and how long we require you to wait before publicly reporting vulnerabilities identified.
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 mb-4 marker:text-[#B5A1D4]">
                  ...
                  <li>Only use exploits to the extent necessary to confirm a vulnerability's presence. Do not use an exploit to compromise or obtain data, establish command line access and/or persistence, or use the exploit to "pivot" to other systems.</li>
                  <li>Once you've established that a vulnerability exists or encounter any sensitive data (including personal data, financial information, or proprietary information or trade secrets of any party), you must stop your test, notify us immediately, and keep the data strictly confidential.</li>
                ...
                <p className="mb-4">
                  Security research carried out in conformity with this policy is deemed permissible. We'll work with you to 
                  swiftly understand and fix the problem, and Sim Studio will not suggest or pursue legal action in connection with your study.
                </p>
                ...
                <p className="mb-4">
                  Any service that isn't explicitly specified above, such as related services, is out of scope and isn't allowed 
                  to be tested. Vulnerabilities discovered in third-party solutions Sim Studio interacts with are not covered by 
                  this policy and should be reported directly to the solution vendor in accordance with their disclosure policy (if any). 
                  Before beginning your inquiry, email us at <Link href="mailto:security@simstudio.ai" className="text-[#B5A1D4] hover:text-[#701ffc]">security@simstudio.ai</Link> if you're unsure whether a system or endpoint is in scope.
                </p>
                ...
                <h3 className="text-xl font-medium mb-2 text-[#B5A1D4]">Reporting a vulnerability</h3>
                <p className="mb-4">
                  To report any security flaws, send an email to <Link href="mailto:security@simstudio.ai" className="text-[#B5A1D4] hover:text-[#701ffc]">security@simstudio.ai</Link>. 
                  The next business day, we'll acknowledge receipt of your vulnerability report and keep you updated on our progress. 
                  Reports can be anonymously submitted.
                </p>
                
                <h3 className="text-xl font-medium mb-2 text-[#B5A1D4]">Desirable information</h3>
                <p className="mb-4">In order to process and react to a vulnerability report, we recommend to include the following information:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4 marker:text-[#B5A1D4]">
                  <li>Vulnerability description</li>
                  <li>Place of discovery</li>
                  <li>Potential Impact</li>
                  <li>Steps required to reproduce a vulnerability (include scripts and screenshots if possible)</li>
                </ul>
                ...
                <p className="mb-4">
                  If you choose to give your contact information, we promise to communicate with you in a transparent and timely manner. 
                  We will acknowledge receipt of your report within three business days. We will keep you informed on vulnerability 
                  confirmation and remedy to the best of our capabilities. We welcome a discussion of concerns and are willing 
