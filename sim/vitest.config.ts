...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      {
        find: '@/blocks/types',
        replacement: path.resolve(__dirname, 'app/blocks/types.ts'),
      },
      {
      ...
      {
        find: '@/executor',
        replacement: path.resolve(__dirname, 'app/executor'),
      },
      {
        find: '@/providers',
        replacement: path.resolve(__dirname, 'app/providers'),
      },
      { find: '@/tools', replacement: path.resolve(__dirname, 'app/tools') },
      { find: '@/blocks', replacement: path.resolve(__dirname, 'app/blocks') },
      {
        find: '@/serializer',
        replacement: path.resolve(__dirname, 'app/serializer'),
      },
